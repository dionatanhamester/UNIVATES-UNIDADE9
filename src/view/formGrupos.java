 ...
 * @author Dionatan
 */
public class formGrupos extends javax.swing.JInternalFrame {
     ...
     */
     public void carregaConfConsulta(){
        ...
        camposCombo[0] = "Código;GRCODIGO";
        camposCombo[1] = "Nome;GRNOME";
        ...
        //função responsavel por carregar os campos da tela de consulta
        ordenaCombo[0] = "Código;GRCODIGO";
        ordenaCombo[1] = "Nome;GRNOME";
    ...
    */
    private void setData(){        
        Ed_Nome.setText(grupo.getGrnome());    
    }
    ...
    */
    private void salvarDados() throws Exception{                
        grupo.setGrnome(Ed_Nome.getText().trim());      
        grupo.setGrdataatu(new Date());
        grupo.setGrhoraatu(new Date());
        if (grupo.getId() == null){
            GruposId idGrupo = new GruposId(Main.empresaSelecionada.getEmcodigo(), gruposDAO.getAutoIncrement());
    ...
    private void initComponents() {
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                .addComponent(BotaoNovo, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BotaoGrava, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BotaoCancela)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BotaoExcluir, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE)
                .addGap(206, 206, 206))
        );
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Ed_Nome, javax.swing.GroupLayout.PREFERRED_SIZE, 354, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void gridConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gridConsultaMouseClicked
       if (evt.getClickCount() == 2){
            ...
            if (row < 0){
                ...
                try{
                    String sql = "FROM Grupos where grcodigo = " + gridConsulta.getValueAt(row, 0).toString() + "";
                    List<Grupos> listGrupos = gruposDAO.consultaSQL(sql);
                    
                    if (listGrupos.size() > 0){
                        this.grupo = listGrupos.get(0);
                        this.setData();                        
                        Tab_Selecao.setSelectedIndex(1);
                        arrumaBotoes(_DEFAULT);
                    }
    ...
    private void BotaoConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoConsultaActionPerformed
        ...
        String vSQL = "FROM Grupos where grcodigo is not null ";
        ...
        Uses.popularTabela(gridConsulta, vSQL, Grupos.class);           
